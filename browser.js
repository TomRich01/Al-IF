$(function() {
        ...
        setTimeout(function () {
            $('#squiffy-editor').squiffyEditor({
                ...
                updateTitle: function (title) {
                    document.title = title + ' - AL IF Editor';
                },
                download: true,
    ...
    if (saved) {
        ...
        init('@title New Game\n\n' +
            'Start writing! Delete all of this text, or play around with it if you\'re new to Al IF.\n\n' +
            ...
            '[[new section]]:\n\nIn addition to sections, Al IF has the concept of passages. These are sections of ' +
